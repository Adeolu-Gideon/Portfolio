...
$(function () {
    ...
    ((Revealator = $.extend({}, { timer: null, busy: !1, scroll_padding: 0, effects_padding: 0, refresh: function () { } }, void 0 !== Revealator ? Revealator : {})).refresh = function () {
        var a = $(window),
            e = $(document),
            o = $(document.body),
        ...
        0 === a.scrollTop()
            ...
            $('*[class*="revealator"]').each(function () {
                ...
                (o =
                    ...
                    (a.removeClass("revealator-below revealator-partially-below revealator-within revealator-partially-above revealator-above"), a.addClass("revealator-within")),
                    a.hasClass(o) ||
                    a.hasClass("revealator-load") ||
                    (a.hasClass("revealator-once")
                        ? (a.hasClass("revealator-within") || (a.removeClass("revealator-below revealator-partially-below revealator-within revealator-partially-above revealator-above"), a.addClass(o)),
                            (a.hasClass("revealator-partially-above") || a.hasClass("revealator-above")) && a.addClass("revealator-within"))
                        : (a.removeClass("revealator-below revealator-partially-below revealator-within revealator-partially-above revealator-above"), a.addClass(o)));
            });
    }),
